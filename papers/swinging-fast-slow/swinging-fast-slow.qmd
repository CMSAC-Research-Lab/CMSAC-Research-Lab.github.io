...
<a href="https://doi.org/10.1080/00031305.2026.2633338" target="_blank" rel="noopener noreferrer" class="bi-bank btn btn-primary" role="button"> The American Statistician</a>
...
<!-- BibTeX -->
<button class="btn btn-info" type="button" data-bs-toggle="collapse" data-bs-target="#powers2026swinging" aria-expanded="false" aria-controls="powers2026swinging">
  BibTeX
</button>
<div class="collapse" id="powers2026swinging">
  <br>
  <div class="card card-body">
```{bibtex}
@article{powers2026swinging,
  title={Swinging, Fast and Slow: Interpreting variation in baseball swing tracking metrics},
